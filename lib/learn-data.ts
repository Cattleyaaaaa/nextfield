...
export const LEARNING_TRACKS: LearningTrack[] = [
  {
    ...
    lessons: [
      { slug: "agent-vs-chat", number: "01", title: z("Agent 不只是聊天框", "An Agent is more than a chat box"), summary: z("用目标、状态、工具与循环重新理解 Agent。", "Understand Agents through goals, state, tools and loops."), minutes: 8,
      ...
      { slug: "rag-pipeline", number: "02", title: z("RAG 是一条证据管线", "RAG is an evidence pipeline"), summary: z("拆开切分、召回、重排、生成与引用验证。", "Separate chunking, retrieval, reranking, generation and citation validation."), minutes: 10,
      ...
      { slug: "tools-and-confirmation", number: "03", title: z("工具调用与确认边界", "Tools and confirmation boundaries"), summary: z("区分读取、写入、外部副作用与不可逆操作。", "Distinguish reads, writes, external side effects and irreversible actions."), minutes: 9,
      ...
      { slug: "evaluation-and-recovery", number: "04", title: z("评估、观测与恢复", "Evaluation, observability and recovery"), summary: z("让失败可以被发现、分类、重现并恢复。", "Make failures detectable, classifiable, reproducible and recoverable."), minutes: 10,
  ...
  },
  {
    ...
    lessons: [
      { slug: "interface-state", number: "01", title: z("界面首先表达状态", "Interfaces express state first"), summary: z("把加载、成功、空数据、失败与恢复设计成明确状态。", "Design loading, success, empty, failure and recovery as explicit states."), minutes: 8,
      ...
      { slug: "api-contracts", number: "02", title: z("API 是稳定契约", "APIs are stable contracts"), summary: z("让客户端和服务端通过明确输入、输出与错误协作。", "Coordinate clients and servers through explicit inputs, outputs and errors."), minutes: 9,
      ...
      { slug: "data-models", number: "03", title: z("数据模型承载产品规则", "Data models carry product rules"), summary: z("从实体、关系、约束和迁移理解数据库设计。", "Understand database design through entities, relationships, constraints and migrations."), minutes: 10,
      ...
      { slug: "production-delivery", number: "04", title: z("从构建到生产交付", "From build to production delivery"), summary: z("用类型、测试、可访问性、性能与观测守住上线质量。", "Protect release quality with types, tests, accessibility, performance and observability."), minutes: 10,
  ...
  },
  {
    ...
    lessons: [
      { slug: "define-the-problem", number: "01", title: z("先定义可信任务", "Define a trustworthy task first"), summary: z("从用户问题、成功指标和风险边界开始，而不是从模型开始。", "Start with the user problem, success criteria and risk boundaries—not the model."), minutes: 8,
      ...
      { slug: "map-the-workflow", number: "02", title: z("把工作流画成状态图", "Map the workflow as a state graph"), summary: z("让规划、检索、工具、确认与恢复成为显式节点。", "Make planning, retrieval, tools, confirmation and recovery explicit nodes."), minutes: 10,
      ...
      { slug: "design-the-surface", number: "03", title: z("设计可控制的产品界面", "Design a controllable product surface"), summary: z("把系统状态、证据、确认和恢复交还给用户。", "Return system state, evidence, confirmation and recovery to the user."), minutes: 9,
      ...
      { slug: "ship-and-observe", number: "04", title: z("上线、观察并继续改进", "Ship, observe and keep improving"), summary: z("建立评估集、运行信号、成本预算和迭代循环。", "Create evaluation sets, runtime signals, cost budgets and an iteration loop."), minutes: 10,
