...
export default async function Page({params}:{params:{id:string}}){
 ...
 const records=await supabase(`/rest/v1/school_attestations?user_id=eq.${params.id}&select=id,lesson_key,issued_at,version&order=issued_at.desc`,undefined,{},true);
