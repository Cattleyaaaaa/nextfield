...
export default async function Page({params}:{params:{id:string}}){
 if(!uuid(params.id))notFound();
 const rows=await supabase(`/rest/v1/school_attestations?id=eq.${params.id}&select=id,user_id,lesson_key,issued_at,version`,undefined,{},true);
